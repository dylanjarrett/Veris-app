...
export default function VerisClientPage() {
      ...
      <div>
        ...
        <div className="space-y-3 text-xs">
          ...
          <TextareaField
            ...
            placeholder="Motivations, timing, property highlights, neighborhood, anything you want Veris to know."
            rows={3}
          />
          <InputField
            label="Your name"
  ...
  return (
    <div className="grid gap-6 rounded-2xl border border-white/10 bg-[rgba(10,12,20,0.98)] p-5 shadow-[0_0_24px_rgba(0,0,0,0.7)] lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1.5fr)]">
      <div>
        ...
        <p className="mb-4 text-xs text-[#AAB4C0]">
          Drop in a common objection and Veris will give you a live talk
