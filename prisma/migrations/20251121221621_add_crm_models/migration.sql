/*
  ...
  - You are about to drop the `ai_activity` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "listings" DROP CONSTRAINT "listings_contactId_fkey";

-- DropForeignKey
ALTER TABLE "tasks" DROP CONSTRAINT "tasks_contactId_fkey";

-- DropTable
DROP TABLE "ai_activity";
